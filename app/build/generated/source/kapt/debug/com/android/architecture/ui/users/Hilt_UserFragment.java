...
public abstract class Hilt_UserFragment extends BaseFragment {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((UserFragment_GeneratedInjector) UnsafeCasts.<GeneratedComponentManagerHolder>unsafeCast(this).generatedComponent()).injectUserFragment(UnsafeCasts.<UserFragment>unsafeCast(this));
    }
  }
}
